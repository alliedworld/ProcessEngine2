...
{
    /// <summary>
    /// Implementation of Property Set Collection with Dictionary Store
    /// </summary>
    public class PropertySetCollection:PropertySetCollectionBase
    {
        ...
        public PropertySetCollection(IPropertySchemaSet schemas)
        {
            Schemas = schemas;
        }
        ...
        public override IPropertySchemaSet Schemas { get; }
        ...
        /// </returns>
        public override ICollection<string> Keys => _store.Keys;
        ...
        /// </returns>
        public override ICollection<object> Values => _store.Values;
